...
namespace Mustorg.ViewModel
{
    public class MyOrdersViewModel : INotifyPropertyChanged
    {
        ...
        public MyOrdersViewModel(IDbCrud dbCrud, ICategoryService categoryService, ICatalogService productCatalogService, IDialogService dialogService, IProfileService profileService, int userId, IFileService fileService)
        {
            _crud = dbCrud;
        ...
        {
            Orders.Clear();
            var orders = _profileService.GetCustomerOrders(_userId, SelectedStatus, DateStart, DateEnd);
        ...
        {
            _fileService.PrintReport(_userId, SelectedStatus, DateStart, DateEnd);
        }
