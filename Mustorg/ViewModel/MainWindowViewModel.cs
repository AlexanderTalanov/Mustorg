    ...
    public class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        public MainWindowViewModel(IDbCrud dbCrud, ICategoryService categoryService, ICatalogService productCatalogService, IOrderService orderService, IDialogService dialogService, IProfileService profileService, int userId, IFileService fileService)
        {
            ...
            try
            {
                ...
                ProfileVM = new ProfileViewModel(dbCrud, categoryService, productCatalogService, dialogService, profileService, userId, fileService);
                HomeVM = new HomeViewModel(dbCrud, categoryService, productCatalogService, dialogService, profileService, userId);
            }
            catch (Exception ex)
            {
            ...
            CartVM.OrderCreated += HomeVM.Update;
            ...
            CartVM.OrderCreated += ProfileVM.CouponsVM.Update;
            CartVM.OrderCreated += ProfileVM.DeliveryVM.Update;
            
            HomeVM.Notify += ChangeTab;
            HomeVM.Notify += CatalogVM.Update;
        }
        ...
        private void ChangeTab(int productId)
        {
            SelectedTab = 1;
        }
